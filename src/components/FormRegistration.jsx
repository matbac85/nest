const FormRegistration = () => (
        ...
        <input id="sirname" type="text" className="input required focus:ring-transparent focus:outline-none mb-6"/>
        <label htmlFor="firstname" className='px-2 mb-1'>Prénom<sup className="text-red-500 font-medium ml-0.5">*</sup></label>
        <input id="firstname" type="text" className="input required focus:ring-transparent focus:outline-none mb-6"/>
        <label htmlFor="email" className='px-2 mb-1'>E-mail<sup className="text-red-500 font-medium ml-0.5">*</sup></label>
        <input id="email" type="email" className="input required focus:ring-transparent focus:outline-none mb-6"/>
        <label htmlFor="password" className='px-2 mb-1'>Mot de passe<sup className="text-red-500 font-medium ml-0.5">*</sup></label>
        <input type="password" className="input required focus:ring-transparent focus:outline-none mb-6"/>
        ...
        <input id="confirmPassword" type="password" className="input required focus:ring-transparent focus:outline-none mb-6"/>
