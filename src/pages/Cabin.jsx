    ...
    return (
        data && data.images ? (
            <div className="bg-backgroundColor max-h-fit pl-56 pr-56 pt-24 pb-24 gap-16 flex justify-between" >
                ...
                {openedModal ?
                    <div id='modal ' className="flex justify-between w-full h-screen rounded-3xl overflow-hidden" style={{ height: "69vh" }}>
                        <button type='button' aria-label='précedente' className='w-1/16 h-full px-8 bg-midGreen' onClick={prevImg}><svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M400 976 0 576l400-400 56 57-343 343 343 343-56 57Z" fill='#ffff' /></svg></button>
                        <img src={data.images[index]} alt="" className=' object-cover' />
                        <button type="button" aria-label='Suivante' className=' w-3/16 h-full px-8 bg-midGreen' onClick={nextImg}><svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="m304 974-56-57 343-343-343-343 56-57 400 400-400 400Z" fill='#ffff' /></svg></button>
                    </div>
                    :
                    <>
                        <div className='w-3/4 mb-24 px-8'>
                            <div className='w-full h-[500px] mb-8 '>
                                <button type='button' className='h-full' onClick={setOpenedModal}>
